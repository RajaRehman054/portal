...
<div class="max-w-4xl mx-auto px-4 py-12">
    <div class="flex flex-col md:flex-row bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div class="md:w-1/2 flex items-center justify-center bg-gradient-to-br from-indigo-50 to-blue-100 p-6">
            <img src="<?php echo e(asset('images/submit_application.png')); ?>" alt="Job Application" class="w-full max-w-xs md:max-w-sm h-auto object-contain">
        </div>
        <!-- Right Side: Form -->
        <div class="md:w-1/2 p-8 flex flex-col justify-center">
            <h2 class="text-2xl font-bold text-indigo-700 mb-4 text-center md:text-left">Apply for <span class="text-indigo-900"><?php echo e($job->Title); ?></span></h2>
            <form action="<?php echo e(route('jobs.apply.submit', $job->JobID)); ?>" method="POST" enctype="multipart/form-data" class="space-y-5">
                <?php echo csrf_field(); ?>
                <div>
            ...
            <div class="text-center mt-4">
                <a href="<?php echo e(route('jobs.index')); ?>" class="text-indigo-500 hover:underline text-sm">&larr; Back to Job Listings</a>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\job_portal\resources\views/jobs/apply.blade.php ENDPATH**/ ?>